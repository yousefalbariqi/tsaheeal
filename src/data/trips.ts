...
export const SEED_TRIPS: Trip[] = [
  { id:"TRP-001", packageId:"PKG-001", transportId:"TRN-001", hotelId:"HTL-001",
    branchId:"BR-004", departureCity:"الدمام", busPlate:"أ ب ج 1234", busCode:"1",
    departureDate:"2025-08-07", returnDate:"2025-08-10", departureTime:"13:00",
    departurePoint:"فرع تساهيل — الدمام", departureMapUrl:"",
  ...
  { id:"TRP-003", packageId:"PKG-003", transportId:"TRN-002", hotelId:"HTL-002",
    branchId:"BR-004", departureCity:"الدمام", busPlate:"د هـ و 5678", busCode:"2",
    departureDate:"2025-08-13", returnDate:"2025-08-18", departureTime:"13:00",
    departurePoint:"فرع تساهيل — الدمام", departureMapUrl:"",
    seats:49, bookedSeats:18, waitingSeats:0, status:"open", price:700,
    drivers:[{id:"d1",name:"سعد القرني",phone:"+966 55 345 6789"}],
    settings:{...DEFAULT_TRIP_SETTINGS} },
  { id:"TRP-005", packageId:"PKG-003", transportId:"TRN-002", hotelId:"HTL-002",
    branchId:"BR-005", departureCity:"الخبر", busPlate:"د هـ و 5678", busCode:"2",
    departureDate:"2025-08-27", returnDate:"2025-09-01", departureTime:"12:00",
    departurePoint:"فرع تساهيل — الخبر", departureMapUrl:"",
    seats:49, bookedSeats:0, waitingSeats:0, status:"open", price:700,
    drivers:[{id:"d1",name:"سعد القرني",phone:"+966 55 345 6789"}],
    settings:{...DEFAULT_TRIP_SETTINGS} },
