...
const CITY_LABEL: Record<Lang, Record<string, string>> = {
  ar: { "مكة": "مكة المكرمة", "المدينة": "المدينة المنورة", "مكة والمدينة": "مكة والمدينة المنورة" },
  en: { "مكة": "Makkah", "المدينة": "Madinah", "مكة والمدينة": "Makkah & Madinah" },
};
...
const D: Record<Lang, Dict> = {
  ar: {
    ...
    chooseTrip:"اختر تاريخ الانطلاق", departure:"الانطلاق", return:"العودة", confirmTrip:"تأكيد رحلة {range}", remaining:"متبقٍ", seat:"مقعد", full:"مكتملة", soldOut:"لا مقاعد متاحة", departureCity:"مدينة الانطلاق", chooseDepartureCity:"اختر مدينة الانطلاق", departureCityHint:"سنُظهر لك الرحلات التي تنطلق من مدينتك فقط.", noDepartureCities:"لا توجد مدن انطلاق متاحة لهذه الباقة حالياً.", searchCity:"ابحث عن مدينتك…", noCityMatch:"لا مدينة بهذا الاسم", clearSearch:"مسح البحث", choose:"اختيار", whoTravels:"من المسافر؟", chooseTravellerType:"اختر نوع المسافر", travellerTypeRequired:"اختيار نوع المسافر مطلوب للمتابعة.", maleSolo:"رجال — فرد أو أكثر", femaleSolo:"نساء — فرد أو أكثر", family:"عائلة", male_solo:"رجال — فرد أو أكثر", female_solo:"نساء — فرد أو أكثر",
    ...
    review:"مراجعة الطلب", package:"الباقة", trip:"الرحلة", room:"السكن", seatArrangedByUs:"سيتم تنظيم مقعدك من جهتنا.",
    ...
    stepLogin:"الدخول", stepData:"البيانات", stepConfirm:"المراجعة",
    // ── واجهة Airbnb ──
    ...
    nextTrip:"أقرب رحلة", seatsLeftCard:"{n} مقعداً متبقياً", seatsLeftCardOne:"مقعد واحد متبقٍ", seatsAvailableCard:"{n}+ مقاعد متاحة", byBus:"بالحافلة", byFlight:"بالطيران", incl:"يشمل", inclHousing:"السكن", inclTransport:"النقل", moreTrips:"+{n} رحلات أخرى",
  ...
  en: {
    ...
    chooseTrip:"Choose departure date", departure:"Departure", return:"Return", confirmTrip:"Confirm trip {range}", remaining:"left", seat:"seat", full:"Full", soldOut:"No seats available", departureCity:"Departure city", chooseDepartureCity:"Choose your departure city", departureCityHint:"We'll show only trips departing from your city.", noDepartureCities:"No departure cities are available for this package right now.", searchCity:"Search your city…", noCityMatch:"No city by that name", clearSearch:"Clear search", choose:"Choose", whoTravels:"Who is travelling?", chooseTravellerType:"Choose traveller type", travellerTypeRequired:"Choose a traveller type to continue.", maleSolo:"Men — one or more", femaleSolo:"Women — one or more", family:"Family", male_solo:"Men — one or more", female_solo:"Women — one or more",
    ...
    total:"Total", passengers:"Pilgrim details", addPassenger:"Add pilgrim", ownerDetails:"Booking owner details", ownerDetailsHint:"Enter your details once, exactly as shown on your official document.", otherPilgrimsTitle:"Other pilgrims’ details", otherPilgrimsNotice:"The remaining pilgrims’ details will be completed before departure. Please arrive early with official documents, or ensure all required registration details are available.",
    ...
    review:"Review order", package:"Package", trip:"Trip", room:"Room", seatArrangedByUs:"Your seat will be arranged by our team.",
    ...
    stepLogin:"Log in", stepData:"Details", stepConfirm:"Review",
    // ── Airbnb-style UI ──
    ...
    nextTrip:"Next trip", seatsLeftCard:"{n} seats left", seatsLeftCardOne:"1 seat left", seatsAvailableCard:"{n}+ seats available", byBus:"By bus", byFlight:"By flight", incl:"Includes", inclHousing:"housing", inclTransport:"transport", moreTrips:"+{n} more trips",
