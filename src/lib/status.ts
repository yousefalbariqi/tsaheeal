...
const LEX: Record<string, Entry> = {
  ...
  /* «متبقٍ قليل» حالةُ عرضٍ تُشتقّ من المقاعد (lib/trip › tripBoardState)
     ولا تُخزَّن: هي اللحظة التي يُقرَّر فيها إطلاق رحلةٍ إضافية، ولا
     تُقرأ من «مفتوحة» وحدها. بلا جنسَين — الوصف للمقاعد لا للكيان. */
  few:              { text: "متبقٍ قليل",              ...G.amber },
